...
const gateDirectionsRoutes = require('./modules/gate-directions/gate-directions.routes');
const gatewayConfigRoutes = require('./modules/gateway-config/gateway-config.routes');
...
app.use('/api/v1/gate-directions', gateDirectionsRoutes);
app.use('/api/v1/gateway-config', gatewayConfigRoutes);
